 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Copy |Paste | Ctrl | RAlt | GUI  |Lower |Space |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_WORKMAN] = LAYOUT_planck_grid(
    ...
    KC_LCTL,             KC_COPY, KC_PASTE, KC_RALT, KC_LALT, KC_LGUI, LOWER,  KC_SPC,   RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
